...
customElements.define('cblcars-button-card-action-handler', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('cblcars-button-card-action-handler')) {
    return body.querySelector('cblcars-button-card-action-handler') as ActionHandler;
  }

  const actionhandler = document.createElement('cblcars-button-card-action-handler');
